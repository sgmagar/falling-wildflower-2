...
## Project Structure
    ...
    ├── falling_wildflower_2  # Django project configurations
...
1. Clone this repo and `cd falling_wildflower_2`
...
2. Clone this repo and `cd falling_wildflower_2`
