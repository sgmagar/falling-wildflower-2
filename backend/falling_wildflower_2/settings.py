"""
Django settings for falling_wildflower_2 project.
...
ROOT_URLCONF = 'falling_wildflower_2.urls'
...
WSGI_APPLICATION = 'falling_wildflower_2.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "falling_wildflower_2 API",
    "DESCRIPTION": "API documentation for falling_wildflower_2 App",
    "VERSION": "v1",
}
